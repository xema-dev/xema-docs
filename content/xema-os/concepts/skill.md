...
slug: skill
title: Skill
summary: A folder bundle that teaches an agent *how* to do something. The only strict file is `SKILL.md` with frontmatter (`name`, `description`); the rest of the bundle — reference docs, scripts, assets, sub-skills — is free-form. Skills are owned by `skill-registry-api` and resolved through the 5-tier scope model.
relatedCommands: []
relatedCapabilities: []
relatedZones: ["org"]
stability: stable
