...
A: Yes. Declare an optional backend service under `backend/api/`. The service is deployed by the biome host when the biome is org-installed and removed when it is archived.
